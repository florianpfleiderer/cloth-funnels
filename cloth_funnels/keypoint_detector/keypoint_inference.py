#%%
import os 
# os.chdir(f"{os.environ['PROJECT_DIR']}/cloth-funnels/cloth_funnels")
import numpy as np
import h5py
...
if __name__ == "__main__":
    ...
    model_path = f'{os.environ["PROJECT_DIR"]}/folding-unfolding/src/outputs/2022-08-26/16-32-41/checkpoints/epoch=292-val_keypoint_dist=2.9334.ckpt'
    model = KeypointDetector(model_path)

    import skvideo.io

    video_path = f'{os.environ["PROJECT_DIR"]}/folding-unfolding/src/shirt_data/buffer0_video.mp4'
    ...
    # with h5py.File(f'{os.environ["PROJECT_DIR"]}/folding-unfolding/src/experiments/03-dc2c-fr-unfn/latest_ckpt_eval_4/replay_buffer.hdf5') as dataset:
